...
const translations = {
  en: {
    ...
    googleCalendar: {
      badge: "New",
      title: "Your tasks, right in Google Calendar",
      subtitle: "Connect your Tasko account and see all your tasks as calendar events. Deadlines, recurring tasks, and reminders — everything synced automatically so you never miss a thing.",
      features: [
        "Automatic two-way sync",
        "Tasks show as calendar events",
        "Deadlines always visible"
      ],
      calendarTitle: "March 2026",
      events: {
        event1: { title: "Pay rent", time: "9:00 AM", day: "5" },
        event2: { title: "Team review", time: "2:00 PM", day: "12" },
        event3: { title: "Design mockups", time: "10:00 AM", day: "18" },
      },
    },
    sharing: {
      badge: "New",
  ...
  es: {
    ...
    googleCalendar: {
      badge: "Nuevo",
      title: "Tus tareas, directo en Google Calendar",
      subtitle: "Conecta tu cuenta de Tasko y ve todas tus tareas como eventos en el calendario. Deadlines, tareas recurrentes y recordatorios — todo sincronizado automaticamente para que no se te pase nada.",
      features: [
        "Sincronizacion automatica bidireccional",
        "Tareas como eventos en el calendario",
        "Deadlines siempre visibles"
      ],
      calendarTitle: "Marzo 2026",
      events: {
        event1: { title: "Pagar alquiler", time: "9:00", day: "5" },
        event2: { title: "Revision equipo", time: "14:00", day: "12" },
        event3: { title: "Disenar mockups", time: "10:00", day: "18" },
      },
    },
    sharing: {
      badge: "Nuevo",
  ...
  return (
    <div className="landing-container">
      ...
      <section className="gcal-section">
        <div className="section-container">
          <div className="gcal-content">
            <div className="gcal-text">
              <div className="gcal-badge">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <rect x="3" y="4" width="18" height="18" rx="2" stroke="currentColor" strokeWidth="2"/>
                  <path d="M16 2v4M8 2v4M3 10h18" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                </svg>
                <span>{t.googleCalendar.badge}</span>
              </div>
              <h2>{t.googleCalendar.title}</h2>
              <p>{t.googleCalendar.subtitle}</p>
              <div className="gcal-features-list">
                {t.googleCalendar.features.map((feature, index) => (
                  <div key={index} className="gcal-feature-item">
                    <svg width="18" height="18" viewBox="0 0 20 20" fill="#4285F4">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                    </svg>
                    <span>{feature}</span>
                  </div>
            ...
            <div className="gcal-visual">
              <div className="gcal-card">
                <div className="gcal-card-header">
                  <div className="gcal-google-icon">
                  ...
                  <span className="gcal-month-title">{t.googleCalendar.calendarTitle}</span>
                  <div className="gcal-google-logo">
                ...
                <div className="gcal-mini-grid">
                  <div className="gcal-day-headers">
                    {(lang === "es"
                      ...
                      <span key={i} className="gcal-day-header">{d}</span>
                    ))}
                  </div>
                  <div className="gcal-days">
                    {Array.from({ length: 31 }, (_, i) => i + 1).map((day) => {
                      const isEvent = [5, 12, 18].includes(day);
                      return (
                        <span
                          key={day}
                          className={`gcal-day ${isEvent ? "gcal-day-event" : ""}`}
                        >
                          {day}
                        </span>
                      );
                ...
                <div className="gcal-events">
                  {Object.values(t.googleCalendar.events).map((event, index) => (
                    <div key={index} className="gcal-event-row">
                      <div className={`gcal-event-dot color-${index}`}></div>
                      <div className="gcal-event-info">
                        <span className="gcal-event-title">{event.title}</span>
                        <span className="gcal-event-time">{event.time} · {lang === "es" ? "Dia" : "Day"} {event.day}</span>
                      </div>
                      <div className="gcal-tasko-tag">tasko</div>
                    </div>
                  ))}
                </div>
                <div className="gcal-sync-indicator">
                  <div className="gcal-sync-dot"></div>
      ...
      <style>{`
        * {
        ...
        .gcal-event-dot.color-0 {
          background: #4285F4;
        }

        .gcal-event-dot.color-1 {
          background: #34A853;
        }

        .gcal-event-dot.color-2 {
          background: #FBBC05;
        }
